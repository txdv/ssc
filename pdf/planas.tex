...
\subsection{Goal}
% dar paprasciau
This thesis will implement compilation unit granularization in a compiler. The expected tasks are

\begin{itemize}
\item palyginti esamus kompiliatorius
\item sukurti kompiliatoriu
\item validavima
\end{itemize}
