...
These compilers re-translate the entire input therefore there will be no variance in the last metric, but the comparison to the measured results in the prototype compiler might give insights on possible performance gains if such a feature were implemented in these compilers.
