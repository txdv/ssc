...
The core idea of the thesis is to granularize the translation unit size order to increase preformance of subsequent compilations of the same source file with minimal source modifications.

A translation unit is the entire input of source code that is compiled and usually compilers re-translate the entire input and recreate the entire compilation output without utilizing previously generated code results.
