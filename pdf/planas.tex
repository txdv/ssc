...
Modern organizations employ DevOps which recompiles a lot of stuff.
As organization grow, the amount of code an organization needs to handle increases together.

Big orgnanization which have a lot of code need efficient compilers to handle the load of compilation
