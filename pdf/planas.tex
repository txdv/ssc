...
Secondly, the granularization feature will be implemented on a class level first and additionally extended to a method level.

Thirdly the metric measurement tool will be created which performs the compilation runs and measurements with various inputs and compilers and generates reproducable outputs.

Lastly, given enough time, additional more complex scala features will be implemented and added to the measurements.
