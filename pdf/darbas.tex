...
Functions in Scala are values and all values are objects which seems
...
Running on the JVM allows Scala easily to utilzie existing Java code, which is a tremendous advantage because utilizing existing Java code opens
