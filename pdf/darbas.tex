...
In the graph which displays the different phases for the prototype compiler (figure \ref{graph:phases}) it is easy to see that entire phases get dropped with caching.
