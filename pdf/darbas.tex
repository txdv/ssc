...
Simple parsers can be easily defined on their own.
Utilizing monad composition, more complex parsers can then be created by combining simple parsers.
A classic functional programming approach to deal with complexity also widely known as a bottom-up approach.

% Scala has a very extensive functional programming community which enables with a fix.
