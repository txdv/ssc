...
The parser starts with a classical lexical analysis step.
...
Characters are grouped into tokens and a stream of tokens is produced with special meaning attached to the tokens in accordance with the Scala langauge specification \cite{ScalaSpec}, keywords of the language have special tokens to represent them and numbers and identifiers generic ones.

%Tokenization is when specific language keywords get translated so special symbols and free standing identifiers are wrapped into a class. 
