...
The main value in the IR is to avoid this split and encode all the constants directly in the IR structure.

% todo: write about how class files are independent from each other and refer to each other with absolute strings
