...
% todo: need citation?
Programming languages have become quite complex, containing multiple paradigms and Scala is certainly one of them.
...
Instead of writing the entire compiler from scratch at once containing all features a more coservative approach was taken.
