...
Additional measurements were taken of the prototype compiler of the following steps:
...
It would create a lot of metrics but without actually implementing the caching mechanism on those layers.
The additional metrics would add little value and would make the benchmarking results harder to read.

\subsection{Sideeffects}
The JVM incures additional costs, 
