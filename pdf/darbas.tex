...
The approach starts out with the most simplistic compiler imaginable, compiling the a bare minimum example of the target programming language, a simple "Hello World" (listing \ref{code:helloworld}) program and then incrementally adding features \cite{IncrementalCompiler}.
...
Talk like half a page of the parser.

% todo: cite

\subsection{Iterative approach}
Creating an entire compile
