...
Šiame darbe pristatomas metodas kompilerio transliavimo našumui pagerinti, kai identiškas išeities tekstas yra transliuojamas iš pakartotinai.
Metodo našumo patobulinimas darbe yra pamatuojamas skirtingiem išeities teksto variantam ir įvairios metrikos yra surenkamos.
Taip pat našumas palyginamas su egzistuojančiu kompileriu.

Klasikiniai kompileriai išeities tekstą vienoje byloje traktuoja kaip neskaldomą transliuojamą vienetą.
Pristatomas metodas bando pasinaudoti modernių programavimo kalbų struktūra ir susmulkinti transliuojamą vienetą transliavimo našumui pagerinti.

Pasirinkta kompilerio kalba yra Scala.
Metodui sparčiam įgyvendinimui yra sukūriamas naujas kompileris nepernaudojant egzistuojančio funkcionalumo.
Naujo kompilerio struktūra nuo pradžių yra pritaikoma metodui įgyvendinti, todėl metodas pritaikomas lengviau.
