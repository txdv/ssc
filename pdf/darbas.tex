...
\item{
  Compilation unit granularization was succesfully implemented in the prototype compiler.
	...
	It targets the JVM which in turn has expects separate class files for every created class while source files had.
}
\item{!Validate correctness for the prototype compiler.}
\item{
  The prototype compiler was benchmarked with inputs of variable size and complexity.
...
\item{
  A comparison to the official Scala compiler was made.
	The prototype compiler operates faster,
}
