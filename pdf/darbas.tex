...
It would create a lot of metrics but without actually implementing the caching mechanism on those layers, additional metrics would add little value and would make the benchmarking results harder to read.
