...
The parser is pretrailed by a classical lexical analysis step which simply groups the input stream of characters into a stream of tokens and assigns a special meaning in accordance with the Scala language specification.
