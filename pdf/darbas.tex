...
The approach was implemented in the prototype compiler the efficienty of the approach was measured.
...
Compilation speed for code with complexity better matching day to day scenarios saw an improvement between 12\% and 16\%
%The more classes a source files contains the more better the performance 
