...
Improvements from 20ms to 480ms can be observed during recompilation \ref{graph:speed} which is an improvement between 5\% and 30\% \ref{graph:something} when amortizing against the total run time.

Applying the approach results in a performance increase of 5\% in the most trivial cases with no downside.
When a source file is very complex containing 100 translation units and 100 methods an improvement of up to 30\% can be observed.
