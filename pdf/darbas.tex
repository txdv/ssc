...
Scalas functional programming community is thriving and many libraries libraries like Cats, Scalaz exist which can be used easily to handle monads on your own.
