...
This allows us to deal with the complexity of Scala on a per demand basis, only features that are absolutely required are implemented.

Parser - The implementation is quite simple featuring a simple tokenizer which 
