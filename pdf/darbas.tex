...
However, shaving off 322ms in a complex translation unit with 50 classes and 50 methods when the entire compilation takes 1084ms \ref{tb:benchmarks} is significant and actually noticeable to the user of the software.
