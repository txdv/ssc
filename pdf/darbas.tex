...
The approach starts out with the most simplistic compiler imaginable, compiling the a bare minimum example of the target programming language, a simple "Hello World" program and then incrementally adding features \cite{IncrementalCompiler}.
